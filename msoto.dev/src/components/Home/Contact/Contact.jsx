...
export default function Contact(){
    ...
    return (
        <section className="flex flex-col sm:px-[45px] px-[25px] py-[45px] gap-[25px] items-center bg-[#e2e2e296]">
            <IconTitle icon='/images/technologies/dark/contactme.png'
                    title={t("title-contact-me")} />

            <div className="flex flex-col lg:flex-row gap-[15px] justify-center w-full items-center text-md">
